...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "About ADEXXA — Tile Adhesive Manufacturer in Uganda" },
      {
        property: "og:description",
        content: "A locally manufactured Ugandan construction-materials brand for tiling projects.",
      },
      ...
      <Section>
        <Container className="grid items-start gap-14 lg:grid-cols-2">
          <div className="space-y-10">
            <div>
              <h2 className="accent-rule font-display text-2xl">Our Story</h2>
              <p className="leading-relaxed text-muted-foreground">
                ADEXXA is a Ugandan tile adhesive and grout brand serving the construction industry. Public
                information identifies an ADEXXA tile adhesive manufacturing operation in {site.manufacturing.area}.
              </p>
              <div className="mt-4">
                <PlaceholderBlock title="Company history — editable">
                  Founding year, milestones and the full company story will be added once supplied.
                </PlaceholderBlock>
              </div>
            </div>

            <div>
              <h2 className="accent-rule font-display text-2xl">Local Manufacturing</h2>
              <p className="leading-relaxed text-muted-foreground">
                ADEXXA products are manufactured locally in Uganda. The manufacturing operation is publicly associated
                with {site.manufacturing.area}. {site.manufacturing.note}
              </p>
            </div>

            <div>
              <h2 className="accent-rule font-display text-2xl">Quality Commitment</h2>
              <PlaceholderBlock title="Quality statement — editable">
                Quality control processes, testing standards and any certifications will be published here once
                officially confirmed. No quality claims are made until then.
              </PlaceholderBlock>
            </div>
          </div>
